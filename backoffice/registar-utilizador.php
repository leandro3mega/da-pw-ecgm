    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body" style="padding-top:0.5rem">
        <form id="formregister" action="register.php" method="post">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" name="username" id="iusername" class="form-control" placeholder="Nome de Utilizador"
                required="required">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" name="password" id="ipassword" class="form-control" placeholder="Palavra Passe"
                    required="required">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" name="confirmPassword" id="iconfirmPassword" class="form-control" placeholder="Confirme a Palavra Passe"
                    required="required">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="label-bold">Fotografia</label>
                      <input type="file" name="avatar" id="avatar_file_upload_field" required accept="image/jpeg,image/png"/>
                  </div>
                </div>
                -->
            </div>
